...
private:
    ...
    void processGPS()
    {
        ...
        // process GPS data
        char c = GPSUART.read();
//        Serial.print("processGPS: ");Serial.println(c);
//        Serial.print("GPS stats: ");Serial.println(gps.satellites());
        if (!gps.encode(c))
            return;

//        Serial.print("GPSUART avail?");Serial.println(GPSUART.available());
...
void setup()
{
    ...
    GPSUART.end();
#endif
    Serial.println("setting up GPS chip");
